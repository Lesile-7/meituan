...
/** 
* @author : MT
* @date 创建时间：2017年10月21日 下午4:23:30 
* @version 1.0 
*/
public class TokenUtil {
	...
	// 读取微信配置文件
	private static PropertiesUtil util = new PropertiesUtil("/config/wechat.properties");
	private static String AppID = util.getProperty("AppID");
	private static String AppSecret = util.getProperty("AppSecret");
	 ...
	 * @return
	 */
	public static WechatToken getToken() {
		WechatToken token = null;
		String requestUrl = token_url.replace("APPID", AppID).replace("APPSECRET", AppSecret);
		// 发起GET请求获取凭证
		JSONObject jsonObject = httpsRequest(requestUrl, "GET", null);
